...
export function AdminPostEdit({ id }: { id: string }) {
  ...
  if (isLoading) return <div style={{ padding: 'var(--space-8)', textAlign: 'center', color: 'var(--color-text-tertiary)' }}><Loader2 size={24} className={styles.spin} style={{ margin: '0 auto var(--space-4)' }} /> Loading post...</div>
