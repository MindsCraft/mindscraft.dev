        ...
        {isOpen && (
          ...
          >
            <div className="faq-item-body">
              <p className="faq-item-answer">{a}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
    ...
    <div className="faq-page">
      ...
      <section className="faq-content">
        <div className="faq-sections">
          {faqs.map((group, gi) => (
            <div key={gi}>
              <h2 className="faq-category-eyebrow">{group.category}</h2>
        ...
        >
          <div className="faq-bottom-cta-icon">
            <FiMail />
          </div>
          <h3 className="faq-bottom-cta-title">Still have questions?</h3>
